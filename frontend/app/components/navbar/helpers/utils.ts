...
export const CASHFLOW_RECURRING_LINK = `/${CASHFLOW_ITEM_NAME_LOWERCASE}/${RECURRENCE_ITEM_NAME_LOWERCASE}`;
...
export const CashflowSubNavItems: NavItem[] = [
  ...
  { href: CASHFLOW_RECURRING_LINK, label: RECURRENCE_ITEM_NAME }
]; 
