...
export const CASHFLOW_SUMMARY_LINK = `/${CASHFLOW_ITEM_NAME_LOWERCASE}/${SUMMARY_ITEM_NAME_LOWERCASE}`;
...
export const CashflowSubNavItems: NavItem[] = [
  ...
  { href: CASHFLOW_SUMMARY_LINK, label: SUMMARY_ITEM_NAME }
]; 
