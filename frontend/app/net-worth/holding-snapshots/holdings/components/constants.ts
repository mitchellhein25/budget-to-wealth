...
export const HOLDING_ITEM_NAME_LOWERCASE_PLURAL = `${HOLDING_ITEM_NAME_LOWERCASE}s`;
...
export const HOLDING_CATEGORY_ITEM_NAME_LINK = HOLDING_CATEGORY_ITEM_NAME_PLURAL_LOWERCASE.replace(" ", "-");