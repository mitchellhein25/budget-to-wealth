public class InvestmentReturnsControllerTestObjects
{
    ...
    public InvestmentReturn TestDefaultManualInvestmentReturn1 => new()
    {
        ...
        ManualInvestmentStartDate = DateOnly.Parse("2023-04-01"),
        ManualInvestmentEndDate = DateOnly.Parse("2023-04-30"),
    ...
    public InvestmentReturn TestUser1ManualInvestmentReturn2 => new()
    {
        ...
        ManualInvestmentStartDate = DateOnly.Parse("2023-05-01"),
        ManualInvestmentEndDate = DateOnly.Parse("2023-05-31"),
    ...
    public InvestmentReturn TestUser2ManualInvestmentReturn3 => new()
    {
        ...
        ManualInvestmentStartDate = DateOnly.Parse("2023-06-01"),
        ManualInvestmentEndDate = DateOnly.Parse("2023-06-30"),
    ...
    public InvestmentReturn TestDefaultManualInvestmentReturn4 => new()
    {
        ManualInvestmentCategoryId = DefaultManualCategory.Id,
        ManualInvestmentCategory = DefaultManualCategory,
        ManualInvestmentStartDate = DateOnly.Parse("2023-07-01"),
        ManualInvestmentEndDate = DateOnly.Parse("2023-07-31"),
